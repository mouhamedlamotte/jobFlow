...
export const SendTestEmail = () => {
  ...
  const { action: resendTestEmailAction } = useHookFormAction(
    sendResendTestEmail,
    zodResolver(z.object({ testEmail: z.string().email() })),
    {
      actionProps: {
        onSuccess: () => {
          toast({
        ...
        onError: (error) => {
          toast({
            ...
            description:
              ...
              "Le serveur n'a pas pu envoyer l'email de test. Veuillez réessayer.",
            variant: "destructive",
          });
        },
      },
  ...
  const { action: stmpTestEmailAction } = useHookFormAction(
    sendSmtpTestEmail,
    zodResolver(z.object({ testEmail: z.string().email() })),
    {
      actionProps: {
        ...
        <Form {...form}>
          ...
          >
            <DialogHeader>
              ...
              <DialogDescription>
                Entrer une adresse email pour envoyer un email de test en
                utilisant vos paramètres {service}.
              </DialogDescription>
            </DialogHeader>
            <FormField
            ...
            <DialogFooter className="flex justify-end">
              <Button
                ...
                type="submit"
                disabled={
                  resendTestEmailAction.status === "executing" ||
                  stmpTestEmailAction.status === "executing"
                }
              >
                {resendTestEmailAction.status === "executing" ||
                stmpTestEmailAction.status === "executing" ? (
