    ...
    <Card>
      ...
      <CardContent>
        <p className="text-gray-700 mb-4">
          Cher recruteur, Je suis très enthousiaste à l'idée de postuler au poste de développeur Full Stack au sein de
        ...
        <p className="text-gray-700 mb-4">
          Au cours de ma carrière, j'ai travaillé sur divers projets utilisant des architectures microservices et j'ai
          une solide expérience avec les bases de données SQL et NoSQL. De plus, ma familiarité avec les méthodologies
          Agile me permet de m'intégrer rapidement dans des équipes dynamiques.
        </p>
      </CardContent>
      <CardFooter>
